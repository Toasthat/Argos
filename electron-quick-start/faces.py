...
def display(loc, dpname):
	...
	cv2.rectangle(frame, (left * 4, top *4), (right * 4, bottom * 4), (0, 153, 0), 2)
	cv2.rectangle(frame, (left * 4, bottom * 4 - 35), (right * 4, bottom * 4), (0, 153, 0), cv2.FILLED)
